...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu // Base Config
  ...
  #define SOUND_OFF_DEFAULT    // Buzzer/speaker default enabled state
